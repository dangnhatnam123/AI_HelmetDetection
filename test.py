...
def test_on_data():
    ...
    test_files = [f for f in os.listdir(TEST_IMG_DIR) if f.lower().endswith("truoc-21-_png.rf.579447b811ffac89aa027cdd54a35db2.jpg")]
    if not test_files:
    ...
    print("ĐÃ HOÀN THÀNH. HÃY MỞ FILE test_result.jpg để xem kết quả.")
